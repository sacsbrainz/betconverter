...
import betBuilder from "~/services/builders/betBuilder";
import { Body } from "~/types/types";

const SportybetToSportybet = async (body: Body) => {
  ...
  try {
    ...
    if (data.message.toLowerCase() === "success") {
      ...
      const resultOutcomes = betBuilder(data.data.outcomes);
...
export default SportybetToSportybet;
